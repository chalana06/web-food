	...
	<div class="inner_content">
		...
		<div class="contact">
			...
			<div class="left">
				...
				<h3>LOCATION</h3>
				<p>Kandy Road, Lanka Food Restaurant</p>
				<p>Visit Srilanka</p>
			...
			<div class="left">
				...
				<h3>CONTACT</h3>
				<p>0352284486, 0719716038</p>
				<p>Lankafood@gmail.com</p>
...
<div class="footer_parallax" onclick="remove_class()">
	...
	<div class="on_footer_parallax">
		...
		<p>&copy; <?php echo strftime("%Y", time()); ?> <span>Lankafood Restaurant</span>. All Rights Reserved</p>
